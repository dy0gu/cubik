...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      const SizedBox(height: 60),
      BlocBuilder<StatisticsBloc, Statistics>(builder: (context, statistics) {
        return statistics.entries.length < 2
            ? Text(
                textAlign: TextAlign.center,
                locale.notEnoughStatisticDataYet(2 - statistics.entries.length),
                      ...
                      child: Stack(
                        children: [
                          LineChart(
                            LineChartData(
                              minX: -2,
                              maxX: statistics.entries.length.toDouble() + 1,
                              minY: 0,
